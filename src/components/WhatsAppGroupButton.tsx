...
// Mobile-first design dengan shadow yang clean tanpa background blok
// ============================================================================
...
export default function WhatsAppGroupButton() {
  ...
  return (
    <>
      {/* Floating Action Button - Clean Mobile Design */}
      <button
        onClick={handleClick}
        onMouseEnter={() => setIsHovered(true)}
        onMouseLeave={() => setIsHovered(false)}
        className="fixed bottom-6 right-6 z-40 w-14 h-14 bg-gradient-to-br from-green-500 to-green-600 text-white rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110 active:scale-95"
        style={{
          boxShadow: '0 4px 14px 0 rgba(34, 197, 94, 0.4), 0 8px 24px 0 rgba(0, 0, 0, 0.15)'
        }}
      ...
      >
        ...
        {isHovered && (
          <div className="hidden md:block absolute bottom-full right-0 mb-3 px-4 py-2 bg-gray-900 text-white text-sm rounded-lg whitespace-nowrap shadow-xl animate-fade-in">
