    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 p-4 print:hidden">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          <h1 className="text-xl font-bold text-gray-900">Laporan Arus Kas</h1>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-lg shadow-sm print:shadow-none print:rounded-none">
            ...
            <div className="border-b border-gray-200 p-8 text-center">
              <h2 className="text-2xl font-bold text-gray-900">{businessInfo?.business_name || 'UMKM'}</h2>
              <p className="text-gray-600 mt-1">{businessInfo?.owner_name || ''}</p>
              <h3 className="text-lg font-semibold text-gray-800 mt-4">LAPORAN ARUS KAS</h3>
              <p className="text-gray-600">Periode: {getMonthName()}</p>
            </div>
            ...
            <div className="p-8 space-y-6">
              ...
              <div>
                <h4 className="font-bold text-gray-900 mb-3 pb-2 border-b">Arus Kas dari Kegiatan Operasi</h4>
                ...
                <div className="space-y-2">
                  ...
                  {Object.entries(cashFlowData.operating.expenses).map(([category, amount]) => (
                    <div key={category} className="flex justify-between text-sm pl-6">
                      <span>{category}</span>
                  ...
                  <div className="flex justify-between font-semibold pt-2 mt-2 border-t">
                    ...
                    <span className={cashFlowData.operating.netOperating >= 0 ? 'text-green-600' : 'text-red-600'}>
              ...
              {Object.keys(cashFlowData.investing.expenses).length > 0 && (
                <div>
                  <h4 className="font-bold text-gray-900 mb-3 pb-2 border-b">Arus Kas dari Kegiatan Investasi</h4>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between font-semibold pt-2 mt-2 border-t">
                      ...
                      <span className="text-red-600">{formatCurrency(cashFlowData.investing.netInvesting)}</span>
                    </div>
                  </div>
                </div>
              )}
              ...
              {Object.keys(cashFlowData.financing.expenses).length > 0 && (
                <div>
                  <h4 className="font-bold text-gray-900 mb-3 pb-2 border-b">Arus Kas dari Kegiatan Pendanaan</h4>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between font-semibold pt-2 mt-2 border-t">
                      ...
                      <span className="text-red-600">{formatCurrency(cashFlowData.financing.netFinancing)}</span>
                    </div>
                  </div>
                </div>
              )}
              ...
              <div className="bg-gray-50 p-4 rounded-lg space-y-2 mt-6">
                ...
                <div className="flex justify-between text-sm text-gray-600">
                  ...
                  <span>{formatCurrency(cashFlowData.openingBalance)}</span>
                </div>
                <div className="flex justify-between font-semibold text-lg pt-2 border-t border-gray-300">
                  ...
                  <span className={cashFlowData.closingBalance >= 0 ? 'text-green-600' : 'text-red-600'}>
            ...
            {/* Footer */}
            <div className="border-t border-gray-200 p-6 text-right text-xs text-gray-500 print:text-gray-700">
